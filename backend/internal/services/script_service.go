...
func (s *ScriptService) GetMyScript(ctx context.Context, userID int64) (*models.Script, error) {
	return s.repo.GetByUserID(ctx, userID)
}

func (s *ScriptService) UpsertMyScript(ctx context.Context, userID int64, content json.RawMessage) error {
	return s.repo.UpsertMyScript(ctx, userID, content)
}
