                ...
                >
                   ...
                   <div className="flex items-start gap-4">
                      ...
                      <div className={`shrink-0 flex items-center justify-center w-12 h-12 rounded-full ${
                          ...
                          <span className="text-[10px] font-bold uppercase tracking-wider">{item.type.substring(0,4)}</span>
                      </div>
                   ...
                   <div className="hidden md:block pr-2">
                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 text-gray-300 group-hover:text-primary transition-colors">
