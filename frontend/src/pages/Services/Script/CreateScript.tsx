...
import ContentForm, { ContentFormValues } from "../../../components/form/ContentForm";
...
export default function CreateScript() {
  ...
  const [initialData, setInitialData] = useState<ContentFormValues | undefined>(undefined);
  ...
  return (
    <>
      <PageBreadcrumb pageTitle={isEditMode ? "Edit Script" : "Tambah Script Baru"} />
      <ContentForm 
        initialValues={initialData}
        onSubmit={handleSave} 
        isSubmitting={isSubmitting} 
        onCancel={() => navigate("/knowledge-base", { state: { activeTab: "script" } })}
