...
interface ScriptFormProps {
  initialValues?: ScriptFormValues;
  onSubmit: (data: ScriptFormValues) => void;
...
export default function ScriptForm({
  ...
  useEffect(() => {
    if (watchedCatId && watchedCatId !== 0) {
      const fetchCategoryProducts = async () => {
        setLoadingProducts(true);
        try {
          const response = await axios.get(API.products.list, {
            params: { categoryId: watchedCatId, limit: 100 },
          });
          ...
          if (
            currentProductId &&
            !products.some((p: any) => p.id === currentProductId)
          ) {
            setValue("product_id", undefined, { shouldDirty: true });
          }
        } catch (error) {
          console.error("Gagal load products untuk kategori ini:", error);
        } finally {
  ...
  }, [watchedCatId, setValue, getValues]);
    ...
    >
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="p-6.5 flex flex-col gap-6">
          ...
          <div className="rounded dark:bg-boxdark dark:border-strokedark">
            ...
            <div className="flex flex-col gap-3">
              ...
              {loadingProducts ? (
                ...
                <div className="w-full animate-in fade-in slide-in-from-top-2 mt-2">
                  <label className="text-xs text-gray-500 mb-1 block">
                  ...
                  <SearchableSelect
                    ...
                    onChange={(val) => {
                      setValue("product_id", val as number | undefined, {
                        shouldValidate: true,
                        shouldDirty: true,
                      });
                    }}
